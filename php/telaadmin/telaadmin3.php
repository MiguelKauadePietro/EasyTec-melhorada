...
<body>
  ...
  <tbody>
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        <td>
        <a class="btn btn-danger" href="mudarfuncao2.php?id=' .$usuario['id']. '&funcao=pro">Professor</a>
        <a class="btn btn-danger" href="mudarfuncao2.php?id=' .$usuario['id']. '&funcao=alu">Aluno</a>
        <a class="btn btn-danger" href="mudarfuncao2.php?id=' .$usuario['id']. '&funcao=fun">Funcionário</a>
        <a class="btn btn-danger" href="mudarfuncao2.php?id=' .$usuario['id']. '&funcao=ter">Tercerizado</a>
...
<!-- Rebaixar Professores -->
    <h1>Rebaixar Professores</h1>
    <div class="table-responsive">
    <div class="table table-bordered">
    <table class="table table-striped">
<thead>
...
//Comando SQL para buscar os usuários inativos
$stmt = "select * from professores where tipo = 's' and funcao = 'adm' and id <> ".$_SESSION['usuario_id'].";";
...
//Comando SQL para buscar os usuários inativos
$stmt = "select * from funcionarios where tipo = 's' and funcao = 'adm' and id <> ".$_SESSION['usuario_id'].";";
...
//Comando SQL para buscar os usuários inativos
$stmt = "select * from tercerizados where tipo = 's' and funcao = 'adm' and id <> ".$_SESSION['usuario_id'].";";
