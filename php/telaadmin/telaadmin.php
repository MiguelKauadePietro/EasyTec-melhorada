            ...
            <div class="table table-bordered">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        //Comando SQL para buscar os usuários inativos
                        $stmt = "select * from professores where tipo = 'n'  and id <> " . $_SESSION['usuario_id'] . ";";
...
<td>' . $usuario['funcao'] . '</td>
<td>
<a class="btn btn-primary" href="mudarstatus.php?id=' . $usuario['id'] . '&tipo=s">Ativar</a>
</td>
</tr>';
                            }
                        } else {
            ...
            <div class="table table-bordered">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        //Comando SQL para buscar os usuários inativos
                        $stmt = "select * from funcionarios where tipo = 'n'  and id <> " . $_SESSION['usuario_id'] . ";";
            ...
            <div class="table table-bordered">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        //Comando SQL para buscar os usuários inativos
                        $stmt = "select * from tercerizados where tipo = 'n' and id <> " . $_SESSION['usuario_id'] . ";";
